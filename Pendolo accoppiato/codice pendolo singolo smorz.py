...
t, x, t2, x2=np.loadtxt("C:/Users/Angelo/Desktop/Università Fisica/Laboratorio 1/Pendolo accoppiato/1PendSmorz.txt", unpack=True)
x-=492
t-=46.964
#x-=474.3
#t-=63.135
...
#popt1, pcov1 = curve_fit(cosine, t, x, p0=(10, 4.45, 0.17, -0.5, 26), sigma=sigma_x,absolute_sigma = True)#2PendControfase
popt1, pcov1 = curve_fit(cosine, t, x, p0=(10, 4.45, 0.17, -0.5, 26),sigma=sigma_x, absolute_sigma = True)#1PendSmorz
