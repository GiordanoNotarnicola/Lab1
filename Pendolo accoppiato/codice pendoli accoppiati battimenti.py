...
plt.errorbar(t, x, sigma_x, sigma_t, fmt='o', label='Dati', color='black')
plt.grid()
plt.plot(xgrid, cosine(xgrid, 64.17, 4.53, 0.09, 4.33, 1.564, 0.0116), color='lightgrey')
plt.xlim(-0.1, 36.5)
plt.xlabel('Tempi [s]')
plt.ylabel('Ampiezza di oscillazione [u]')
plt.show()
